...
if __name__ == '__main__':
    ...
    flight_time_df1 = spark.read.json("hdfs://namenode:8020/user/spark/data/dataframe-join/d1/")
    flight_time_df2 = spark.read.json("hdfs://namenode:8020/user/spark/data/dataframe-join/d2/")
